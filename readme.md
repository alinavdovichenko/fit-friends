...
5. В данном проекте требовалось запрограммировать Frontend. Некоторые компоненты работают не корректно, потому что пока нет Бэкенда. Дальше если на второй итерации мы будем создавать Бэкенд, то это все исправится.

6. Ссылка на этот проект https://github.com/alinavdovichenko/fit-friends
